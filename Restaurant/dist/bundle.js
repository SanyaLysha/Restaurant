...
/******/ 	return __webpack_require__(__webpack_require__.s = "./Content/src/Dish.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
const DishBox_1 = __webpack_require__(/*! ./DishBox */ "./Content/src/DishBox.tsx");
ReactDOM.render(React.createElement("div", null,
    React.createElement(DishBox_1.DishBox, null)), document.getElementById("foodorder"));


/***/ }),

/***/ "./Content/src/DishBox.tsx":
/*!*********************************!*\
  !*** ./Content/src/DishBox.tsx ***!
  \*********************************/
/*! no static exports found */
...
class DishBox extends React.Component {
    constructor(state) {
        super(state);
        this.state = { dishes: null, showPopUp: false, userId: 1 };
        this.loadDishesFromServer();
    }
    loadDishesFromServer() {
        var xhr = new XMLHttpRequest();
        xhr.open('get', '/data/GetDishes/', true);
        xhr.onload = function () {
            var dataItems = JSON.parse(xhr.responseText);
            var tmp = this.state;
            tmp.dishes = dataItems;
            this.setState(tmp);
        }.bind(this);
        xhr.send();
    }
    render() {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { id: "wrapper" },
                React.createElement("div", { id: "dishes" }, dishes))));
    }
}
exports.DishBox = DishBox;
