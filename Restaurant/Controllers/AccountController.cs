...
namespace Restaurant.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(RegisterViewModel user)
        {
            var pass = Hashing.GetHashString(user.Password);
            User usr = DbContext.Users.Where(u => u.Email == user.Email && u.Password == pass).FirstOrDefault();
        ...
        {
            User usr = DbContext.Users.Where(u => u.Email == user.Email).FirstOrDefault();
            if (usr != null)
            {
                ViewBag.ErrMsg = "User with this Email exsists!";
            }
            else
            {
                DbContext.Users.Add(new User()
                {
                    ...
                    Phone = user.Phone,
                    Email = user.Email,
                    Password = Hashing.GetHashString(user.Password)
                });
                DbContext.SaveChanges();
                ViewBag.SuccessMsg = "User created.";
            }
            return View(user);
        }
